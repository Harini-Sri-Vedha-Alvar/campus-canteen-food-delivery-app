...
const GENERATED_MODULE = "src/.generated/mockup-components.js";
export function mockupPreviewPlugin() {
    ...
    function isMockupFile(absolutePath) {
        ...
        return (!rel.startsWith("..") && !path.isAbsolute(rel) && rel.endsWith(".jsx"));
    }
    ...
    async function discoverComponents() {
        const files = await glob(`${MOCKUPS_DIR}/**/*.jsx`, {
            cwd: root,
            ignore: ["**/_*/**", "**/_*.jsx"],
        });
        return files.map((f) => ({
