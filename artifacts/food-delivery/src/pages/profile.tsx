        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              {editing ? (
                <Input value={name} onChange={e => setName(e.target.value)} className="h-8 text-sm" data-testid="input-name" />
              ) : (
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              {editing ? (
                <Input value={phone} onChange={e => setPhone(e.target.value)} className="h-8 text-sm" placeholder="+91 XXXXX XXXXX" data-testid="input-phone" />
              ) : (
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              {editing ? (
                <Input value={address} onChange={e => setAddress(e.target.value)} className="h-8 text-sm" placeholder="Enter your address" data-testid="input-address" />
              ) : (
