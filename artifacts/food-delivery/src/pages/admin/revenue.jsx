...
export default function AdminRevenue() {
    ...
    return (<div className="container mx-auto px-4 py-8">
      ...
      {isLoading ? (<div className="space-y-4">
          ...
          {(revenue?.revenueByDay || revenue?.dailyRevenue)?.length > 0 && (<Card className="border-border/50 mb-6">
              ...
              <CardContent>
                <div className="flex items-end gap-1 h-48 overflow-x-auto pb-2">
                  {(revenue.revenueByDay || revenue.dailyRevenue).map(day => {
                    ...
                    return (<div key={day.date} className="flex flex-col items-center gap-1 flex-1 min-w-8" title={`₹${day.revenue}`}>
          ...
          {revenue?.topRestaurants?.length > 0 && (<Card className="border-border/50">
              ...
              <CardContent>
                <div className="space-y-3">
                  {revenue.topRestaurants.map((r, idx) => {
                    ...
                    return (<div key={r.restaurantId || idx} className="flex items-center gap-3">
