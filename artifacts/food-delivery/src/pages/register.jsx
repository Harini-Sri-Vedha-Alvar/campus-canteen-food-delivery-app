...
export default function Register() {
    ...
    const validate = () => {
        ...
        if (!agree)
            errs.agree = "Please accept the terms";
        setErrors(errs);
    ...
    return (<div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border border-border/60 rounded-2xl shadow-xl p-8">
          <button type="button" onClick={handleGoogle} className="w-full flex items-center justify-center gap-3 h-11 rounded-xl border-2 border-border hover:border-primary/40 hover:bg-primary/5 transition-all font-medium text-sm mb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <Input placeholder="Rahul Sharma" className={`pl-10 h-11 ${errors.name ? "border-destructive" : ""}`} value={form.name} onChange={set("name")}/>
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input type="email" placeholder="you@example.com" className={`pl-10 h-11 ${errors.email ? "border-destructive" : ""}`} value={form.email} onChange={set("email")}/>
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input type="tel" placeholder="+91 98765 43210" className="pl-10 h-11" value={form.phone} onChange={set("phone")}/>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input type={showPassword ? "text" : "password"} placeholder="••••••••" className={`pl-10 pr-10 h-11 ${errors.password ? "border-destructive" : ""}`} value={form.password} onChange={set("password")}/>
              ...
              {form.password && (<div className="flex gap-3 mt-2">
                  {PASSWORD_RULES.map(rule => (<div key={rule.label} className={`flex items-center gap-1 text-xs ${rule.test(form.password) ? "text-green-600" : "text-muted-foreground"}`}>
            ...
            <div className="flex items-start gap-2">
              <input type="checkbox" id="agree" checked={agree} onChange={e => { setAgree(e.target.checked); setErrors(err => ({ ...err, agree: "" })); }} className="mt-0.5 h-4 w-4 rounded border-border accent-primary"/>
