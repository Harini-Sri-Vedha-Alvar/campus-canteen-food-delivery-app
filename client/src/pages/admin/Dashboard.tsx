      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {stats.map((stat, i) => {
            ...
            return (
              <div key={i} className="bg-card p-6 rounded-3xl border-2 border-border shadow-sm flex items-center gap-4">
        ...
        <div className="bg-card border-2 border-border rounded-3xl p-8 shadow-sm">
          ...
          <div className="space-y-4">
            {orders.slice(0, 5).map(order => (
              <div key={order.id} className="flex justify-between items-center p-4 border border-border rounded-xl hover:bg-muted/50 transition-colors">
                <div>
