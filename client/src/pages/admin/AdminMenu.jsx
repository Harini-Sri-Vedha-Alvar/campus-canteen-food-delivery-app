...
const formSchema = z.object({
  ...
  priceDollars: z.coerce.number().min(0.01, "Price must be > 0"),
  // Accept dollars in form
...
function AdminMenu() {
  ...
  />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {menuItems.map((item) => <div key={item.id} className="bg-card border-2 border-border rounded-3xl overflow-hidden shadow-sm flex flex-col group hover:border-accent/30 transition-colors">
  ...
  >
          ...
          {menuItems.length === 0 && <div className="col-span-full py-12 text-center bg-muted/20 border-2 border-dashed border-border rounded-3xl">
