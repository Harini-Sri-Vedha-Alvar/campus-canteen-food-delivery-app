...
import { Trash2, MenuSquare, Plus } from "lucide-react";
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y border-border">
                {restaurants.map((r) => <tr key={r.id} className="hover:bg-muted/20 transition-colors group">
