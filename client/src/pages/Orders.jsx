...
function Orders() {
  ...
  return <div className="min-h-screen bg-muted/20 py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        {orders.length === 0 ? <div className="text-center py-20 bg-card rounded-3xl border-2 border-border shadow-sm">
  ...
  >
                ...
                <div className="space-y-3">
                  {order.items.map((item, idx) => <div key={idx} className="flex justify-between items-center text-sm sm:text-base">
