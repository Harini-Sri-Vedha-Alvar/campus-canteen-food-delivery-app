...
function Register() {
  ...
  return <div className="min-h-screen flex flex-col md:flex-row-reverse">
  ...
  >
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 bg-white p-6 sm:p-8 rounded-3xl shadow-bold border-2 border-border/50">
            {register.error && <div className="p-4 bg-destructive/10 text-destructive font-semibold rounded-xl border border-destructive/20 text-sm">
