    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        <Button variant="outline" className="relative group overflow-hidden border-2 border-primary/20 bg-primary/5 hover:bg-primary/10">
          ...
          {itemCount > 0 && (
            <span className="absolute -top-1 -right-1 bg-primary text-white text-[10px] font-bold px-2 py-0.5 rounded-full">
              {itemCount}
            </span>
          )}
        </Button>
      ...
      <SheetContent className="w-full sm:max-w-md flex flex-col p-0 border-l-0 shadow-2xl">
        ...
        {cart.length > 0 && (
          <div className="p-6 border-t border-border/50 bg-background shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.1)] z-10 relative">
